...
public class Level3Screen extends LevelScreen implements Screen, Serializable {
...
//    private Texture slingLeft;
    ...
    private Hstone hstone1;
    private Hstone hstone2;
    private Vstone vstone1;
    private Vstone vstone2;
    private Vstone vstone3;
...
//        slingLeft = new Texture("slingleft.png");
        ...
        //materials
        hstone1 = new Hstone(world, 800f, 635f-455f+212f+150f+100f);
        vwood1 = new Vwood(world, 800f-106f+11f, 635f-455f+106f);
        vwood2 = new Vwood(world, 800f+106f-11f, 635f-455f+106f);
        vglass3= new Vglass(world, 800f, 635f-455f+106f);
        vstone1 = new Vstone(world, 800f-106f+13f, 635f-455f+212f+150f);
        vstone2 = new Vstone(world, 800f+106f-13f, 635f-455f+212f+150f);
        hwood = new Hwood(world,800f, 635f-455f+212f );
        //hstone = new Hstone(world, 800f, 635f-455f+212f+22f);

        //pigs
        pigga1 = new Pigga(world, 800f, 635f-455f+130f);
        pigga2 = new Pigga(world, 800f-5f, 635f-455f+130f);
        mustPig = new MustPig(world, 800f, 690f);
        kingPig = new KingPig(world, 800f, 635f-455f+212f+22f);
//        box2ddebugrenderer = new Box2DDebugRenderer();
    ...
    public void render(float v) {
        ...
        hstone1.render(game.batch);
        vwood1.render(game.batch);
        vwood2.render(game.batch);
        vglass3.render(game.batch);
        vstone1.render(game.batch);
        vstone2.render(game.batch);
        ...
        if (pigsnumber == 0) {
            levelStatusManager.setLevelStatus("level3", "pass");
